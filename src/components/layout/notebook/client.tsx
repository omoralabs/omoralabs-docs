...
import { usePageData } from "../../../contexts/page-data-context";
import { cn } from "../../../lib/cn";
import { CombinedPageActions } from "../../ai/page-actions";
...
export function LayoutBody({
  ...
  const pageCol =
    "calc(var(--fd-layout-width,100%) - var(--fd-sidebar-col) - var(--fd-toc-width))";
...
export function NavbarPageActions() {
  const pageData = usePageData();

  if (!pageData.markdownUrl || !pageData.githubUrl) {
    return null;
  }

  return <CombinedPageActions markdownUrl={pageData.markdownUrl} />;
}
