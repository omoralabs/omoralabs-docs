---
title: Architecture
description: "Omora Labs is built on a three-layer architecture that separates semantic-aware transformation, business logic, and reporting, ensuring financial definitions are encoded once and reused everywhere."
---

import {Layers, Box, Table2, Shuffle, Cpu} from 'lucide-react'
...
The semantic layer defines the core business concepts of the organization before any data is ingested. [Dimensions](/dimensions) such as Periods, GL Accounts, Business Units, Revenue Types, Revenue Changes, and Value Types encode financial meaning, hierarchies, and classification rules once, in code.

These definitions are authoritative. They act as a contract: all incoming data, downstream transformations, and reports must conform to them. The semantic layer determines what concepts exist, how they relate, and how business logic is interpreted, independent of any specific dataset.
...
**Stack**: [Dagster](https://dagster.io/) | [Polars](https://pola.rs/)
...
<div className="mt-8 grid gap-4 sm:grid-cols-2 sm:gap-6">
  ...
  <LinkedCard href="templates">
    ...
    <p className="mt-2 dark:text-gray-300 dark:font-light">Templates</p>
  </LinkedCard>
</div>
