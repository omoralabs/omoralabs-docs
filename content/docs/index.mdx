---
title: Introduction
description: "Omora Labs provides reusable finance data components - transformations, semantic dimensions, and reporting blocks — for building production-grade analytics pipelines. Code-first, version-controlled, no vendor lock-in."
---
