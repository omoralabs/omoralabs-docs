---
title: Introduction
description: "A set of reusable components and blocks for building modern finance analytics. Works with modern data stacks and analytics tools. Open source. Open code."
---

You know how most finance departments work: the accounting team runs the books on the traditional ERP. You download all the data into your spreadsheet. Then grab the numbers from file `budget_v3_approved.xlsx` to run the budget vs actuals alongside the board deck and SaaS metrics the CEO just asked. The investors are waiting.
